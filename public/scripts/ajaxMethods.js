...
// FAVORITE A MAP
const favoritingUser = 3;
const favData = {id: 5, userid: favoritingUser, mapid};
$.ajax({
  method: "POST",
  url: `/api/users/${favoritingUser}/favorites`,
  data: favData
}).done (() => {
  console.log(`User with id: ${favoritingUser} favorited map with id ${mapid}`);
});
